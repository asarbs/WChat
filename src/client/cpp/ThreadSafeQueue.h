...
using ToWebSockerQueue = ThreadSafeQueue<WChat::ChatClient::ServerAPI::ProtoBuffer>;

using FromWebSockerQueue = ThreadSafeQueue<WChat::ChatClient::ServerAPI::ProtoRxMessages>;
