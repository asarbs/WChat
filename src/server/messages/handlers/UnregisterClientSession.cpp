...
namespace WChat::ChatServer::messages::handlers {
    UnregisterClientSession::UnregisterClientSession() {
    }

    UnregisterClientSession::~UnregisterClientSession() {
    }

    void UnregisterClientSession::handle(websocket_server* s, const websocketpp::connection_hdl& hdl, WChat::Msg msg) {
